...
export class FcScheduleList extends BaseElement {
    ...
    _filtered() {
        ...
        if (!q) return this._schedules
        return this._schedules.filter(s => (s.name ?? '').toLowerCase().includes(q) || s.className.toLowerCase().includes(q))
    }
                                  ...
                                  >
                                      ...
                                      <div class="px-4 pt-4 pb-3 bg-gradient-to-br from-primary/5 via-transparent to-transparent">
                                          <div class="flex items-start gap-2.5">
                                              <div
                                                  class="w-8 h-8 rounded-lg bg-primary/10 text-primary flex items-center justify-center shrink-0 mt-0.5"
                                              >
                                                  <svg
                                                      class="w-4 h-4"
                                                      fill="none"
                                              ...
                                              <div class="min-w-0 flex-1">
                                                  ...
                                                  <div
                                                      class="text-[10px] text-base-content/35 mt-1 truncate font-mono"
                                      ...
                                      <div class="px-4 py-3 flex-1 flex flex-col justify-center border-t border-base-300/50">
                                          <div class="text-center">
                                              <div class="text-lg font-semibold text-base-content/80 leading-tight">
                                                  ${isRaw ? '' : human}
                                              </div>
                                              <div class="mt-1.5">
                                                  <span
                                                      class="badge badge-sm badge-ghost font-mono text-[10px] tracking-wider text-base-content/40"
