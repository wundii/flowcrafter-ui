...
export class FcFlowList extends BaseElement {
  ...
  render() {
    ...
    if (this.flows.length === 0) return html`
      <div class="alert alert-info"><span>Keine Flows gefunden.</span></div>
    `

    return html`
      <!-- Toolbar -->
      <div class="flex items-center justify-between mb-4">
        <button class="btn btn-sm btn-ghost border border-base-content/30 hover:border-base-content/50" @click=${this._onBack}>← Zurück zur Schema-Übersicht</button>
              ...
              <div class="grid grid-cols-[1fr_auto] gap-2 px-4 py-3">
                ...
                <div class="min-w-0">
                  ...
                  <div class="text-sm text-base-content/50 leading-snug break-words mb-2">
                    ${flow.flowSubject || html`<span class="font-mono" style="font-size:11px;">${flow.flowHash.slice(0, 20)}…</span>`}
                  </div>
