...
export class FcFlowDetail extends BaseElement {
    static properties = {
        ...
        _analysisStreamText: { state: true },
    ...
    async _runAnalysis() {
        ...
        try {
            const result = await api.analyzeFlow(
                ...
                event => {
                    if (event.type === 'delta') {
                        this._analysisStreamText += event.text
                    } else {
                    ...
                    this._toast
                        ? html`
                              <div class="toast toast-top toast-end z-50">
                                  <div
                                      class="alert ${
                                          this._toast.type === 'success' ? 'alert-success' : 'alert-error'
                                      } shadow-lg text-sm py-2 px-4"
                                  >
                                          ...
                                          <div class="flex items-center gap-3">
                                              ...
                                              <div>
                                                  ...
                                                  <span class="text-xs text-base-content/50"
                                                      >${this.flow ? shortClass(this.flow.flowSource) : ''}${
                                                          this._analysisModel
                                                              ? html` ·
                                                                    <span
                                                                        class="${
                                                ...
                                                >
                                                    ...
                                                    <div class="flex gap-2">
                                                        <button
                                                            ...
                                                            @click=${() => (this._analysisConfirmClose = false)}
                                                        >
                                                            Weiter
                                                        </button>
                                                    ...
                                                    <div class="py-8 flex flex-col items-center gap-4">
                                                        <ul class="steps steps-vertical">
                                                            ${this._analysisSteps.map(
                                                                (step, i) => html`
                                                                    <li
                                                                        class="step ${i < this._analysisSteps.length - 1 ? 'step-primary' : ''}"
                                                                    >
                                                                        <span
                                                                            class="text-xs text-left ${
                                                                                i === this._analysisSteps.length - 1
                                                        ...
                                                        ${
                                                            this._analysisStreamText
                                                                ? html`
                                                                      <pre
                                                                          class="max-h-40 w-full overflow-hidden whitespace-pre-wrap break-all rounded-lg bg-base-200 p-3 font-mono text-[10px] leading-relaxed text-base-content/50"
                                                                      >
${this._analysisStreamText.slice(-600)}</pre>
                                                                  `
                                                                : ''
                                                        }
                                                    </div>
                                                ...
                                                : this._analysis
                                                  ? html`
                                                        ...
                                                        <div class="rounded-lg bg-base-200 border border-base-300 p-4 mb-5">
                                                            <div
                                                                class="text-xs font-semibold uppercase tracking-wider text-base-content/40 mb-1.5"
                                                            >
                                                                Zusammenfassung
                                                            </div>
                                                            <p class="text-sm text-base-content/80 leading-r  elaxed">
                                                                ...
                                                                ? html`
                                                                      <div class="flex items-center gap-2 text-success py-4">
                                                                          ...
                                                                          <span class="text-sm font-medium"
                                                                              >Keine Auffälligkeiten gefunden</span
                                                                          >
                                                                      </div>
                                                                  `
                                                                : html`
                                                                      <div class="flex flex-col gap-3">
                                                                          ${this._analysis.findings.map(
                                                                              f => html`
                                                                                  <div
                                                                                      class="rounded-lg border p-4 ${categoryColor(f.category)}"
                                                                                  >
                                                                                      <div class="flex items-start gap-3">
                                                                                          ...
                                                                                          <div class="flex-1 min-w-0">
                                                                                              <div
                                                                                                  class="flex items-center gap-2 flex-wrap mb-1.5"
                                                                                              >
                                                                                                  <span
                                          ...
                                          ? html`
                                                ...
                                                >
                                                    ...
                                                    <span
                                                        ...
                                                        ${(
                                                            this._analysisUsage.inputTokens + this._analysisUsage.outputTokens
                                    ...
                                    <tr class="border-t border-base-200 align-top">
                                        ...
                                        <td
                                            class="font-mono text-xs ${
                                                f.onlyA ? 'bg-error/10 text-error' : 'bg-error/5 text-base-content/60'
                                            }"
                                        >
                                            ${renderVal(f.valueA)}
                                        </td>
                                        <td
                                            class="font-mono text-xs ${
                                                f.onlyB ? 'bg-success/10 text-success' : 'bg-success/5 text-base-content/60'
                                            }"
                                        >
                                            ${renderVal(f.valueB)}
                                        </td>
                        ...
                        d.exceptionsA.length > 0 || d.exceptionsB.length > 0
                            ? html`
                                  <div class="flex items-center gap-2 mb-3 mt-5">
                                      <span
                                          class="inline-flex items-center gap-1 text-xs font-semibold uppercase tracking-wide text-error/80"
                                      >
                                          <svg class="w-3 h-3" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                                              <path
                                                  stroke-linecap="round"
                                ...
                                <div class="flex items-center gap-2 mb-1">
                                    <span
                                        class="font-semibold text-xs ${
                                            selected ? 'text-primary' : isCompare ? 'text-info' : 'text-base-content/70'
                                        }"
                                    >
                                        ${run.label}
                                    </span>
